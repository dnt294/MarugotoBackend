class NewWordsController < ApplicationController
    ...
    def new_word_params
        params.require(:new_word).permit(:word, :kanji_version, :meaning, :note, :lesson_id, :word_type, adj_form_attributes: [:adj_type], verb_form_attributes: [:verb_type, :dictionary_form, :nai_form, :te_form])
    end
end
